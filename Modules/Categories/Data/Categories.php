 ...
 * @author ramesh
 */
class Modules_Categories_Data_Categories
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("ec_categories");
            $registerController->setNodeNameData("ec_categories");
            $registerController->setDisplayValue("Categories");
            $registerController->setIsModule("0");
            $registerController->setRootModuleId("categories");
            $registerController->setModuleId("categories");
            $registerController->setModuleDisplayId("categories");
            ...
            $registerController->setRegisternodeId("ec_categories");           
            $registerController->setTablename("ec_categories");
