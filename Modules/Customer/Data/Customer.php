 ...
 * @author ramesh
 */
class Modules_Customer_Data_Customer
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("ec_customer");
            $registerController->setNodeNameData("ec_customer");
            $registerController->setDisplayValue("Customer");
            ...
            $registerController->setRegisternodeId("ec_customer");           
            $registerController->setTablename("ec_customer");
            $registerController->setAutokey("id");
            $registerController->setPrimarykey("id");
            $registerController->setDescriptorkey("first_name");
            $registerController->setMandotatoryAdd("first_name | last_name | email | phone_number");
            $registerController->setMandotatoryEdit("first_name | last_name | email | phone_number");
