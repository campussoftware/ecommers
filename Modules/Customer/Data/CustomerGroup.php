 ...
 * @author ramesh
 */
class Modules_Customer_Data_CustomerGroup
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("ec_customer_group");
            $registerController->setNodeNameData("ec_customer_group");
            $registerController->setDisplayValue("Customer Group");
            ...
            $registerController->setRegisternodeId("ec_customer_group");           
            $registerController->setTablename("ec_customer_group");
            ...
            $registerController->setCoreNodeActionsId("admin|edit|delete|view");  
