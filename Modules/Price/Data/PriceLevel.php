 ...
 * @author ramesh
 */
class Modules_Price_Data_PriceLevel
{
    //put your code here
    public function execute()
    {
        ...
        {            
            ...
            $registerController->setNodeFileName("ec_price_level");
            $registerController->setNodeNameData("ec_price_level");
            $registerController->setDisplayValue("Price Level");
            ...
            $registerController->setRegisternodeId("ec_price_level");           
            $registerController->setTablename("ec_price_level");
